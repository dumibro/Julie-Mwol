...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By king dumiyah whatsapp bot' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒KING DUMIYAH‒‒‒⊣' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'true' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? 'ඔබගේ ගීතය DOWNLOAD කරමින්🍁' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? 'ඔබගේ ගීතය UPLOAD කරමින්🍁' : process.env.SONGU,
