...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'wolf ?(.*)', fromMe: false,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/wolflogo?apikey=cjxJIn9eDletRHac3CG6CdvGxFH&text1=` + Config.AFN + `&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
